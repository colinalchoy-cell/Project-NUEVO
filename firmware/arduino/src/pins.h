...
#define PIN_M2_EN               9       // PWM Enable (speed control) [Timer4 OC4B]    normally 7
#define PIN_M2_IN1              34       // Direction control 1          normally 4
#define PIN_M2_IN2              35      // Direction control 2          normally 30
...
#define PIN_M3_EN               7       // PWM Enable (speed control)      normally 9
#define PIN_M3_IN1              4      // Direction control 1        normally 34
#define PIN_M3_IN2              30      // Direction control 2        normally 35
...
#define PIN_M3_CT               A4      // Current sense (analog)       normally A5
